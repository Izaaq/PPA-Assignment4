...
public class AirbnbListing {
    ...
    double reviewsPerMonth, int calculatedHostListingsCount, int availability365) {
        ...
        if(reviewsPerMonth == -1){
            this.reviewsPerMonth = 0;
        } else {
    ...
    public String toString() {
        ...
        System.out.println(", reviewsPerMonth=" + reviewsPerMonth);
    ...
    /***
     * Returns a nicer version of the toString() method to be displayed.
     * @return A text that shows the information about a single listing.
     */
    public String getListingTextDisplay(){
        String textDisplay = 
            "ID: " + id + "\n" +
            "Name: " + name + "\n" +
            "Host ID: " + host_id + "\n" +
            ...
            "Number of host's other properties: " + calculatedHostListingsCount + "\n" +
